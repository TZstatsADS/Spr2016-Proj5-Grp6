...
##Comparison Text
Right now, it is the book, `War and Peace`, but maybe dictionary will be better? I also uploaded beauty and the beast to try as an alternative/shorter text.

```{r}
#Input a baseline text fille to decode
reference <- readLines("C:\\Users\\NMLJ\\Documents\\GitHub\\finalfroject-p5-team6\\data\\warandpeace.txt")
...
#Use Simple Sub and Permutation Method to improve accuracy
